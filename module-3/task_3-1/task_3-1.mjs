...
if (Timer === 7) {
  ...
  printOut("Timer went off at 8")  
  printOut("I can take the train to school.");
} else {
  printOut("Timer did not go off")  
  printOut("I can to take the car to school.");
}
printOut(newLine);
...
if(number > 0){
  ...
  printOut("Neither negative nor positive, number is zero");
}
